...
def build_doc():
    ...
    add_table(
        ...
        [
            ...
            ["OMS前端", "发货管理、拆合弹窗、结果档案及售后页面", "完成Tab切换与查询条件保留、温层快捷/自定义拆分、售后订单列表、紧凑型申请售后弹窗、数量/金额校验、详情和推送结果展示。", "P0"],
            ...
            ["测试团队", "端到端、表单校验与并发测试", "覆盖前置拆合、驳回拆合、多级拆合、两类售后申请、数量/金额边界、重复提交、售后完成推送1条、重复完成事件幂等及推送失败重试。", "P0"],
