...
$doc='E:\cxy\09-设计与原型\17-订单履约时效管理原型\订单履约时效管理PRD_V1.1_20260911.docx'
$out='E:\cxy\09-设计与原型\17-订单履约时效管理原型\tools\prd-qa-20260911-final'
...
try{
 ...
 $opened=$word.Documents.Open($doc,$false,$true,$false,'','','','','',0,$false,$true,$false,$true)
